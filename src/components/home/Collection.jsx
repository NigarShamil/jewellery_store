    ...
    return (
        <div className='flex justify-center items-center'>
            <div className='col_banner relative'>
                <img src="https://molla-theme.myshopify.com/cdn/shop/files/banner-4_9dc81ef5-0994-4f07-bbd7-228d3f224528.jpg?v=1614737572" className='col-cover w-[100%] h-[80vh] object-cover object-right-[0px_0px]' />
